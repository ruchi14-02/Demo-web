...
<h1><i><u>Book Writing</u></i></h1>

  <div class="row" style="padding:10">
    <div class="col-sm-4 col-md-4">
     <img src="images2.jpg" alt="Smiley face" height="400" width="400">
    </div>
	<br>
...
What makes you pick up or download a new book at the bookstore?
...
The book description includes just enough about what is going to happen in the book, to make the reader yearn for answers to all the questions flitting through his or her mind…if the author has succeeded in writing a captivating description.</p>
</div>
  </div>
