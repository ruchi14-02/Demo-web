...
<div style="color:grey">
  ...
  <tbody>
    <?php
    $sql = "SELECT getjob.id,getjob.Name,getjob.Email,getjob.Mobile,getjob.charge,getjob.days,status1.id,status1.status,status1.demo_id_fk
From getjob,status1
where (getjob.id = status1.demo_id_fk) and (status1.status = '1')
ORDER BY getjob.id";
