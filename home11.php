...
body  
{
 ...
 `    
		 ...
		 <br>
		<center>
        <p><a  style = "border:1px solid white;margin-right:30px;"href="h1.php" class="btn btn-primary">I am a EMPLOYER</a>
		<a style="border:1px solid white;" href="h2.php" class="btn btn-danger">i am a  FREELANCER</a></p>
		</center>
  <br>
<br><br>
<br><br>
