...
$demo = "select * from status1 where demo_id_fk = '$demo_id'";

$result = mysqli_query($conn, $demo);
...
$sql = "INSERT INTO `status1`(`status`,`demo_id_fk`)VALUES('$status','$demo_id')";

try{
    if(mysqli_query($conn,$sql))
  echo "<script>alert(susseccful changes)</script>";
  else
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="myproject.php" class="nav-link">My project</a></li>
					 ...
					 <li class="nav-item"><a href="confirmbid.php" class="nav-link">confirm bids</a></li>
...
<td><?php echo $row[3];?></td>
	...
	<td><input type ="hidden" value="<?php echo $row[0];?>" name ="text" autocomplete="off" placeholder="Enter id"></td>
	<td>
